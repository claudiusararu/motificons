...
server so coding agents can pick icons from a user's curated collection.
...
- [For coding agents](${SITE_ORIGIN}/agents): the MCP server, what it does, and how to connect.
